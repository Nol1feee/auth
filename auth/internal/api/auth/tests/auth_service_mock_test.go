...
//go:generate minimock -i github.com/Nol1feee/CLI-chat/auth/internal/service.AuthService -o ./auth_service_mock_test.go -n AuthServiceMock
...
func (mmCreate *mAuthServiceMockCreate) Expect(ctx context.Context, req *model.UserInfo) *mAuthServiceMockCreate {
	...
	mmCreate.defaultExpectation.params = &AuthServiceMockCreateParams{ctx, req}
...
func (mmCreate *mAuthServiceMockCreate) Inspect(f func(ctx context.Context, req *model.UserInfo)) *mAuthServiceMockCreate {
...
func (mmCreate *mAuthServiceMockCreate) Set(f func(ctx context.Context, req *model.UserInfo) (i1 int64, err error)) *AuthServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mAuthServiceMockCreate) When(ctx context.Context, req *model.UserInfo) *AuthServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthServiceMock.Create mock is already set by Set")
	}
	...
	expectation := &AuthServiceMockCreateExpectation{
		mock:   mmCreate.mock,
		params: &AuthServiceMockCreateParams{ctx, req},
	}
...
func (mmCreate *AuthServiceMock) Create(ctx context.Context, req *model.UserInfo) (i1 int64, err error) {
	...
	mm_params := &AuthServiceMockCreateParams{ctx, req}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := AuthServiceMockCreateParams{ctx, req}
	...
	mmCreate.t.Fatalf("Unexpected call to AuthServiceMock.Create. %v %v", ctx, req)
	return
}
...
func (mmUpdate *mAuthServiceMockUpdate) Expect(ctx context.Context, req *model.UserUpdate) *mAuthServiceMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &AuthServiceMockUpdateParams{ctx, req}
...
func (mmUpdate *mAuthServiceMockUpdate) Inspect(f func(ctx context.Context, req *model.UserUpdate)) *mAuthServiceMockUpdate {
...
func (mmUpdate *mAuthServiceMockUpdate) Set(f func(ctx context.Context, req *model.UserUpdate) (err error)) *AuthServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mAuthServiceMockUpdate) When(ctx context.Context, req *model.UserUpdate) *AuthServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthServiceMock.Update mock is already set by Set")
	}
	...
	expectation := &AuthServiceMockUpdateExpectation{
		mock:   mmUpdate.mock,
		params: &AuthServiceMockUpdateParams{ctx, req},
	}
...
func (mmUpdate *AuthServiceMock) Update(ctx context.Context, req *model.UserUpdate) (err error) {
	...
	mm_params := &AuthServiceMockUpdateParams{ctx, req}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := AuthServiceMockUpdateParams{ctx, req}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmUpdate.t.Fatalf("Unexpected call to AuthServiceMock.Update. %v %v", ctx, req)
	return
}
