...
//go:generate minimock -i github.com/Nol1feee/CLI-chat/auth/internal/repository.AuthRepository -o ./auth_repository_mock_test.go -n AuthRepositoryMock
...
type AuthRepositoryMock struct {
	...
	funcUpdate          func(ctx context.Context, req *model.UserUpdate) (err error)
	inspectFuncUpdate   func(ctx context.Context, req *model.UserUpdate)
...
func (mmCreate *mAuthRepositoryMockCreate) Expect(ctx context.Context, req *model.UserInfo) *mAuthRepositoryMockCreate {
	...
	mmCreate.defaultExpectation.params = &AuthRepositoryMockCreateParams{ctx, req}
...
func (mmCreate *mAuthRepositoryMockCreate) Inspect(f func(ctx context.Context, req *model.UserInfo)) *mAuthRepositoryMockCreate {
...
func (mmCreate *mAuthRepositoryMockCreate) Set(f func(ctx context.Context, req *model.UserInfo) (i1 int64, err error)) *AuthRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mAuthRepositoryMockCreate) When(ctx context.Context, req *model.UserInfo) *AuthRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthRepositoryMock.Create mock is already set by Set")
	}
	...
	expectation := &AuthRepositoryMockCreateExpectation{
		mock:   mmCreate.mock,
		params: &AuthRepositoryMockCreateParams{ctx, req},
	}
...
func (mmCreate *AuthRepositoryMock) Create(ctx context.Context, req *model.UserInfo) (i1 int64, err error) {
	...
	mm_params := &AuthRepositoryMockCreateParams{ctx, req}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := AuthRepositoryMockCreateParams{ctx, req}
	...
	mmCreate.t.Fatalf("Unexpected call to AuthRepositoryMock.Create. %v %v", ctx, req)
	return
}
...
func (mmUpdate *mAuthRepositoryMockUpdate) Expect(ctx context.Context, req *model.UserUpdate) *mAuthRepositoryMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &AuthRepositoryMockUpdateParams{ctx, req}
...
func (mmUpdate *mAuthRepositoryMockUpdate) Inspect(f func(ctx context.Context, req *model.UserUpdate)) *mAuthRepositoryMockUpdate {
...
func (mmUpdate *mAuthRepositoryMockUpdate) Set(f func(ctx context.Context, req *model.UserUpdate) (err error)) *AuthRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mAuthRepositoryMockUpdate) When(ctx context.Context, req *model.UserUpdate) *AuthRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthRepositoryMock.Update mock is already set by Set")
	}
	...
	expectation := &AuthRepositoryMockUpdateExpectation{
		mock:   mmUpdate.mock,
		params: &AuthRepositoryMockUpdateParams{ctx, req},
	}
...
func (mmUpdate *AuthRepositoryMock) Update(ctx context.Context, req *model.UserUpdate) (err error) {
	...
	mm_params := &AuthRepositoryMockUpdateParams{ctx, req}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := AuthRepositoryMockUpdateParams{ctx, req}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmUpdate.t.Fatalf("Unexpected call to AuthRepositoryMock.Update. %v %v", ctx, req)
	return
}
