...
func (c *chatServerV1Client) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chatServer_v1.ChatServer_v1/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServerV1Client) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/chatServer_v1.ChatServer_v1/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServerV1Client) SendMessage(ctx context.Context, in *SendMessageRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/chatServer_v1.ChatServer_v1/SendMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ChatServerV1_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chatServer_v1.ChatServer_v1/Create",
	}
...
func _ChatServerV1_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chatServer_v1.ChatServer_v1/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ChatServerV1_SendMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chatServer_v1.ChatServer_v1/SendMessage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ChatServerV1_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "chatServer_v1.ChatServer_v1",
